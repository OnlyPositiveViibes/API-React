...
/* harmony export */ });
var ajaxServices = function ajaxServices(term) {
  var url = "https://api.postit.lt/?term=";
  var key = "wudk30BeblUfYKlXJFaB";
  return fetch("".concat(url).concat(term, "&key=").concat(key)).then(function (response) {
    return response.json();
  });
};

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ajaxServices);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _ajaxServices__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ajaxServices */ "./src/modules/ajaxServices.js");
...
var searchCode = function searchCode() {
  document.querySelector('form').addEventListener('submit', function (event) {
    ...
    var searchResponse;
    (0,_ajaxServices__WEBPACK_IMPORTED_MODULE_0__["default"])(searchTerm).then(function (result) {
